...
function signInPage() {
    ...
    first.setAttribute(
        "style",
        "height:450px; width:500px; border: 2px solid black; background: white; position: absolute; top: 100px; left: 50%; transform: translateX(-50%); padding: 20px; text-align: center; box-shadow: 10px 10px 10px rgba(49, 48, 48, 0.6);"
    );
...
function displayProduct(product) {
    ...
    buyButton.addEventListener("click", function () {
        alert("Payment Successful!"); // Placeholder action
    });
